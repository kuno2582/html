 ...
 * Generated at: 2017-01-22 08:44:55 UTC
...
public final class info_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\r\n");
      out.write("\t<div class=\"banner-bottom-info\" id=\"moveup\">\r\n");
      out.write("\t\t<div class=\"bottom-teaminfo\">\r\n");
      out.write("\t\t\t<div class=\"bottom-teaminfo-left\"><a href=\"#\"><img src=\"images/back.png\" width=\"25px\" height=\"25px\"></a></div>\r\n");
      out.write("\t\t\t<div class=\"bottom-teaminfo-center\"><div class=\"tinfo-center-con\"><div class=\"con-cell\"><b>팀 정보</b></div></div></div>\r\n");
      out.write("\t\t\t<div class=\"bottom-teaminfo-right\"><a href=\"#\" id=\"fix-team\"><img src=\"images/teamInfoFix.png\" width=\"35px\" height=\"35px\"></a></div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"bottom-teamContent\">\r\n");
      out.write("\t\t\t<div class=\"bottom-teamName\"></div>\r\n");
      out.write("\t\t\t<br><p>주장: </p><input type=\"text\" id=\"leader\" value=\"임정환\" disabled size=\"5\"><br>\r\n");
      out.write("\t\t\t<p>팀 대표 전화: </p><input id=\"team-phone\" disabled size=\"12\" value=\"010-8911-9621\"><br>\r\n");
      out.write("\t\t\t<p>활동지역: </p><input id=\"team-region\" disabled size=\"15\" value=\"성남시, 서울남부\"><br>\r\n");
      out.write("\t\t\t<p>유니폼: </p><input id=\"team-uniform\" disabled size=\"3\" value=\"검/빨\"><br>\r\n");
      out.write("\t\t\t<hr>\r\n");
      out.write("\t\t\t<p>Level: </p><p id=\"team-level\">7</p><br>\r\n");
      out.write("\t\t\t<p>승률: </p><p id=\"team-winRate\">8/2/0 80%</p><br>\r\n");
      out.write("\t\t\t<p>패널티: </p><p id=\"team-pannelty\">레드카드 2개</p><br>\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("\t\t$('#fix-team').click(function(){\r\n");
      out.write("\t\t\tif($(this).hasClass('fixOn')){\r\n");
      out.write("\t\t\t\t$('.con-cell b').html('팀 정보');\r\n");
      out.write("\t\t\t\t$('.bottom-teaminfo-right img').attr('src','images/fix.png');\r\n");
      out.write("\t\t\t\t$('.bottom-teamContent input').css('background','white').css('border','none').attr('disabled',true);\r\n");
      out.write("\t\t\t\t$(this).removeClass('fixOn');\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\t$(this).addClass('fixOn');\r\n");
      out.write("\t\t\t\t$('.con-cell b').html('팀 정보 관리');\r\n");
      out.write("\t\t\t\t$('.bottom-teaminfo-right img').attr('src','images/teamInfoFixConfirm.png');\r\n");
      out.write("\t\t\t\t$('.bottom-teamContent input').css('background','rgb(235,235,228)').css('border','1px solid gray').removeAttr('disabled');\r\n");
      out.write("\t\t\t}\t\t\t\t\t\r\n");
      out.write("\t\t});\r\n");
      out.write("\t</script>\r\n");
      out.write("\r\n");
